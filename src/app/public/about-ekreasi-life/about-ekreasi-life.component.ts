...
@Component({
  selector: 'app-about-ekreasi-life',
  templateUrl: './about-ekreasi-life.component.html',
  styleUrls: ['./about-ekreasi-life.component.scss'],
	providers: [ Config ]
})
export class AboutekreasiLifeComponent implements OnInit {
  public data : any = {};
  ...
  ngOnInit() {
    ...
    this.http.get( this.cnf.URLWS + '/about_ekreasi_life/frontend/all?appid=3K123451&appkey=3K123451&lang=' + this.cnf.lang )
		.subscribe(
      (res:any) => {
        if(res.status == 100){
          this.data = res.datas;
